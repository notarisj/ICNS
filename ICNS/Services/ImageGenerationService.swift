...
class ImageGenerationService {
    ...
    func generateIcons(from image: NSImage, outputDirectory: URL, profile: ExportProfile, iconName: String) -> Result<URL, Error> {
    ...
    func generateICNS(from iconName: String, inside outputDirectory: URL) -> Result<URL, Error> {
        let iconsetFolder = outputDirectory.appendingPathComponent("\(iconName).iconset")
